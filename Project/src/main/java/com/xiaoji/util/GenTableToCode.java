...
public class GenTableToCode {
    private String packageOutPath = "com.xiaoji.model";//指定实体生成所在包的路径
    private String authorName = "wkm";//作者名字
    private String tableName = "contract_info";//表名
    ...
    //数据库连接
    private static final String URL ="jdbc:mysql://192.168.0.178:3306/xiaoji_project_managerment?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true";
...
//            System.out.println( "\\src\\\\main\\java\\"+this.packageOutPath.replace(".", "\\")+"\\"+initCap(tableName) + ".java");
            String outputPath = directory.getAbsolutePath()+ "\\bbc\\src\\\\main\\java\\"+this.packageOutPath.replace(".", "\\")+"\\"+changeTableNameStr  + ".java";
//            System.out.println(directory.getAbsolutePath());
            File file = new File(outputPath);
            if(!file.exists()){
                file = new File(directory.getAbsolutePath()+ "\\bbc\\src\\\\main\\java\\"+this.packageOutPath.replace(".", "\\"),changeTableNameStr  + ".java");
                file.createNewFile();
            }
...
//        tableNames.add("contract_info");
//        tableNames.add("invoice_info");
        tableNames.add("reimburse_info");
